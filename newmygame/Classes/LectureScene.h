...
#ifndef __mygame__LectureScene__
#define __mygame__LectureScene__
...
#include "Julia.h"
class LectureScene : public cocos2d::Layer
{
public:
    ...
    CREATE_FUNC(LectureScene);
};

#endif /* defined(__mygame__LectureScene__) */
